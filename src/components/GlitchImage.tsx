export const GLITCH_KEYFRAMES = css`
  @keyframes glitch-anim {
    0% {
      clip: rect(22px, 9999px, 79px, 0);
    }
    5% {
      clip: rect(159px, 9999px, 25px, 0);
    }
    10% {
      clip: rect(151px, 9999px, 35px, 0);
    }
    15% {
      clip: rect(86px, 9999px, 70px, 0);
    }
    20% {
      clip: rect(8px, 9999px, 110px, 0);
    }
    25% {
    ...
    35% {
      clip: rect(31px, 9999px, 154px, 0);
    }
    40% {
      clip: rect(135px, 9999px, 84px, 0);
    }
    45% {
      clip: rect(28px, 9999px, 43px, 0);
    }
    50% {
      clip: rect(68px, 9999px, 133px, 0);
    }
    55% {
      clip: rect(158px, 9999px, 22px, 0);
    }
    60% {
      clip: rect(102px, 9999px, 103px, 0);
    }
    65% {
      clip: rect(70px, 9999px, 161px, 0);
    }
    70% {
      clip: rect(94px, 9999px, 146px, 0);
    }
    75% {
      clip: rect(160px, 9999px, 26px, 0);
    }
    80% {
...
export const GLITCH_STYLES = css`
  :root {
    --color-text: #fff;
    --color-bg: #000;
    --color-link: #f9d77e;
...
export const GlitchImage = styled.div`
  .glitch__item {
    background: url("https://images.unsplash.com/photo-1482245294234-b3f2f8d5f1a4?ixlib=rb-0.3.5&q=85&fm=jpg&crop=entropy&cs=srgb&ixid=eyJhcHBfaWQiOjE0NTg5fQ&s=1922d6e6f96e8e67aac67057877e15da")
...
const GlitchImage: FunctionComponent<GlitchImageProps> = () => {
  return (
    <div class="glitch">
